...
// NewStore creates a Store with the given TTL and starts the background cleanup goroutine.
...
// Set stores a span keyed by HAProxy unique-id.
...
// Get retrieves the in-flight span for the given request ID.
...
// Delete removes the span entry for the given request ID.
